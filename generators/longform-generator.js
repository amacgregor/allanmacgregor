...
module.exports = plop => {
    plop.setGenerator('longform entry', {
        prompts: [
            {
                type: 'input',
                name: 'title',
            ...
            },
            {
                ...
                name: 'confidence',
                message: 'Confidence:',
                choices: ['believed', 'semi-believed', 'not-believed', 'speculation', 'fiction', 'emotional', 'log'],
        ...
        actions: data => {
            ...
            return [
                {
                    type: 'add',
                    path: '../src/pages/essays/{{createdDate}}---{{dashCase title}}/index.md',
