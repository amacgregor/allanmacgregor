---
title: Writing long-form content
date: '2020-05-03'
description: 'Ideas and concepts that evolve overtime.'
category: Writing
tags:
  - information
  - writing
...
layout: essay
published: true
confidence: semi-believed
path: '/essays/writing-long-form-content'
...
<!--Meta page describing the site concept, purpose and the overall idea to produce long-term content which continues to improve over time; writing methodology, original sources for the idea and overall vision as it evolves-->
